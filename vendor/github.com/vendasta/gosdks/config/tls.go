...
// Get returns the TLS configuration for this instance based on the environment.
func GetTlsConfig() *tls.Config {
	tlsCert := os.Getenv("TLS_CERT_FILE")
	tlsKey := os.Getenv("TLS_KEY_FILE")

	cer, err := tls.LoadX509KeyPair(tlsCert, tlsKey); if err != nil {
	...
	if !isSet {
		...
		pemData, err := ioutil.ReadFile(caFile); if err != nil {
